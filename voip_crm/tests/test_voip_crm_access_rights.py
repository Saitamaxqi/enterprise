...
class TestVoipCrmAccessRights(common.TransactionCase):
    def test_team_leader_access_on_subordinates_calls(self):
        ...
        """
        team_leader = new_test_user(self.env, login="team_leader", groups="base.group_user")
        team = self.env["crm.team"].create({"name": "Sales Team", "user_id": team_leader.id})
        team_member = new_test_user(self.env, login="team_member", groups="base.group_user")
    ...
    def test_team_leader_access_on_non_subordinate_calls(self):
        ...
        not_in_the_team = new_test_user(self.env, login="not_in_the_team", groups="base.group_user")
