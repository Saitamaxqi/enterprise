        ...
        for worked_days in hk_worked_days:
            ...
            if worked_days.payslip_id.wage_type == "hourly":
                ...
                if worked_days.work_entry_type_id.l10n_hk_use_713:
                    hourly_wage = max(hourly_wage, worked_days.payslip_id.l10n_hk_average_daily_wage / worked_days.version_id.resource_calendar_id.hours_per_day)
                ...
                if worked_days.work_entry_type_id.l10n_hk_use_713:
                    daily_wage = max(daily_wage, payslip.l10n_hk_average_daily_wage)
