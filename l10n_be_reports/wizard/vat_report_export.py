...
class L10n_Be_ReportsPeriodicVatXmlExport(models.TransientModel):
    ...
    def _compute_show_prorata(self):
        for record in self:
            ...
            record.show_prorata = date_to.month in (1, 2, 3) or (
                date_to.year in (2024, 2025) and date_to.month in (4, 5, 6)
            )
    ...
    def _get_submission_options_to_inject(self):
        ...
        return {
            ...
            'prorata_deduction': prorata_deduction,
        }
