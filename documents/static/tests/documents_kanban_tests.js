        ...
        "documents_kanban_tests.js",
        {
            async beforeEach() {
                ...
                const documentsFolderIds = pyEnv["documents.document"].create([
                    { name: "Workspace1", type: "folder", access_internal: "edit", user_permission: "edit", is_pinned_folder: true, folder_id: false, owner_id: false },
                    { name: "Workspace2", type: "folder", access_internal: "edit", user_permission: "edit", is_pinned_folder: true, folder_id: false, owner_id: false },
                ]);
