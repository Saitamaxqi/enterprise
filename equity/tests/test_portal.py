...
class TestEquityPortal(TestEquityCommon, HttpCase):
    ...
    def test_portal_my_company_equity(self):
        ...
        self.assertEqual(return_value['transactions'], [
            {
                ...
                'expiration_date': '',
                'expired': False,
                'event': 'Shares Issuance',
                'share_class': 'ORD',
                'sign': 1,
                'securities': 50.0,
                'formatted_securities': '+50.0',
                'security_price': 10.0,
            ...
            },
            {
                'date': date(2010, 6, 1),
                'transaction_type': 'option',
                'expiration_date': date(2013, 6, 1),
                'expired': False,
                'event': 'Options Issuance',
                'share_class': 'ORD',
                'sign': 1,
                'securities': 100.0,
                'formatted_securities': '+100.0',
                'security_price': 10.0,
                'transaction_price': '',
            },
            {
        ...
        self.assertEqual(return_value['chart_props']['data'], {
            'Feb 2010': [333.33333333333333333, 1000.0],
            'Mar 2010': [333.33333333333333333, 1000.0],
            'Apr 2010': [333.33333333333333333, 1000.0],
            'May 2010': [333.33333333333333333, 1000.0],
            'Jun 2010': [500.0, 1000.0],
            'Jul 2010': [500.0, 1000.0],
            'Aug 2010': [1000.0, 2000.0],
            'Sep 2010': [1000.0, 2000.0],
            'Oct 2010': [1000.0, 2000.0],
            'Nov 2010': [1000.0, 2000.0],
            'Dec 2010': [1000.0, 2000.0],
            'Jan 2011': [1000.0, 2000.0],
        })
