...
class PosConfig(models.Model):
    ...
    settle_due_product_id = fields.Many2one('product.product', string='Settle Due Product', help="This product is used as to settle due of customer account.")
    deposit_product_id = fields.Many2one('product.product', string='Deposit Product', help="This product is used to deposit money on customer account.")
