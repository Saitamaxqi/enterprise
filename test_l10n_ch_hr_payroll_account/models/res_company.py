...
class ResCompany(models.Model):
    ...
    def _l10n_ch_generate_swissdec_demo_data(self):
        ...
        self.env['hr.salary.attachment'].create([
            # TF01
            {'description': 'Salaire horaire', 'monthly_amount': 160.0, 'total_amount': 320.0, 'date_start': date(2022, 1, 1), 'date_end': date(2022, 2, 28), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf01'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 170.0, 'total_amount': 170.0, 'date_start': date(2022, 3, 1), 'date_end': date(2022, 3, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf01'].id)]},
            {'description': 'Gratification', 'monthly_amount': 20000, 'total_amount': 20000, 'date_start': date(2022, 10, 1), 'date_end': date(2022, 10, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_gratification').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf01'].id)]},
            {'description': 'Part facultative employeurs LPP', 'monthly_amount': 682, 'total_amount': 2046, 'date_start': date(2022, 1, 1), 'date_end': date(2022, 3, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_optional_lpp').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf01'].id)]},
            {'description': 'Indemnité APG', 'monthly_amount': 1200, 'total_amount': 1200, 'date_start': date(2022, 3, 1), 'date_end': date(2022, 3, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_indemnity_apg').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf01'].id)]},
            {'description': 'Indemnité APG', 'monthly_amount': 1300, 'total_amount': 1300, 'date_start': date(2022, 5, 1), 'date_end': date(2022, 5, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_indemnity_apg').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf01'].id)]},
            {'description': 'Prestation compensation mil. (CCM)', 'monthly_amount': 1000, 'total_amount': 1000, 'date_start': date(2022, 3, 1), 'date_end': date(2022, 3, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_military_wage').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf01'].id)]},
            {'description': 'Indemnité journalière accident', 'monthly_amount': 1250, 'total_amount': 2500, 'date_start': date(2022, 1, 1), 'date_end': date(2022, 2, 28), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_indemnity_accident').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf01'].id)]},
            {'description': 'Indemnité maladie', 'monthly_amount': 250, 'total_amount': 500, 'date_start': date(2022, 1, 1), 'date_end': date(2022, 2, 28), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_indemnity_illness').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf01'].id)]},
            {'description': 'Indemnité maladie', 'monthly_amount': 1000, 'total_amount': 1000, 'date_start': date(2022, 5, 1), 'date_end': date(2022, 5, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_indemnity_illness').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf01'].id)]},
            # TF02
            {'description': 'Salaire horaire', 'monthly_amount': 150.0, 'total_amount': 150.0, 'date_start': date(2022, 1, 1), 'date_end': date(2022, 1, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 70.0, 'total_amount': 140.0, 'date_start': date(2022, 2, 1), 'date_end': date(2022, 3, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 142.0, 'total_amount': 142.0, 'date_start': date(2022, 4, 1), 'date_end': date(2022, 4, 30), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 20.0, 'total_amount': 20.0, 'date_start': date(2022, 5, 1), 'date_end': date(2022, 5, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 100.0, 'total_amount': 100.0, 'date_start': date(2022, 6, 1), 'date_end': date(2022, 6, 30), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 120.0, 'total_amount': 120.0, 'date_start': date(2022, 7, 1), 'date_end': date(2022, 7, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 130.0, 'total_amount': 130.0, 'date_start': date(2022, 8, 1), 'date_end': date(2022, 8, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 162.0, 'total_amount': 162.0, 'date_start': date(2022, 9, 1), 'date_end': date(2022, 9, 30), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 50.0, 'total_amount': 50.0, 'date_start': date(2022, 10, 1), 'date_end': date(2022, 10, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 162.0, 'total_amount': 162.0, 'date_start': date(2022, 11, 1), 'date_end': date(2022, 11, 30), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 150.0, 'total_amount': 150.0, 'date_start': date(2022, 12, 1), 'date_end': date(2022, 12, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 120.0, 'total_amount': 120.0, 'date_start': date(2023, 1, 1), 'date_end': date(2023, 1, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 50.0, 'total_amount': 50.0, 'date_start': date(2023, 2, 1), 'date_end': date(2023, 2, 28), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            {'description': 'Salaire à la leçon', 'monthly_amount': 20.0, 'total_amount': 20.0, 'date_start': date(2022, 1, 1), 'date_end': date(2022, 1, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_salary_lesson').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            {'description': 'Salaire à la leçon', 'monthly_amount': 20.0, 'total_amount': 20.0, 'date_start': date(2022, 5, 1), 'date_end': date(2022, 5, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_salary_lesson').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            {'description': 'Salaire à la leçon', 'monthly_amount': 40.0, 'total_amount': 40.0, 'date_start': date(2022, 6, 1), 'date_end': date(2022, 6, 30), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_salary_lesson').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            {'description': 'Salaire à la leçon', 'monthly_amount': 20.0, 'total_amount': 40.0, 'date_start': date(2022, 7, 1), 'date_end': date(2022, 8, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_salary_lesson').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            {'description': 'Salaire à la leçon', 'monthly_amount': 20.0, 'total_amount': 20.0, 'date_start': date(2022, 10, 1), 'date_end': date(2022, 10, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_salary_lesson').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            {'description': 'Salaire à la leçon', 'monthly_amount': 20.0, 'total_amount': 20.0, 'date_start': date(2022, 12, 1), 'date_end': date(2022, 12, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_salary_lesson').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            {'description': 'Salaire à la leçon', 'monthly_amount': 20.0, 'total_amount': 20.0, 'date_start': date(2023, 1, 1), 'date_end': date(2023, 1, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_salary_lesson').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            {'description': 'Indemnité travail par équipes', 'monthly_amount': 90, 'total_amount': 90, 'date_start': date(2022, 1, 1), 'date_end': date(2022, 1, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_team_work').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            {'description': 'Indemnité travail par équipes', 'monthly_amount': 50, 'total_amount': 50, 'date_start': date(2022, 2, 1), 'date_end': date(2022, 2, 28), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_team_work').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            {'description': 'Indemnité travail par équipes', 'monthly_amount': 25, 'total_amount': 25, 'date_start': date(2022, 3, 1), 'date_end': date(2022, 3, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_team_work').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            {'description': 'Indemnité travail par équipes', 'monthly_amount': 35, 'total_amount': 35, 'date_start': date(2022, 4, 1), 'date_end': date(2022, 4, 30), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_team_work').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            {'description': 'Indemnité travail par équipes', 'monthly_amount': 40, 'total_amount': 40, 'date_start': date(2022, 5, 1), 'date_end': date(2022, 5, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_team_work').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            {'description': 'Indemnité travail par équipes', 'monthly_amount': 35, 'total_amount': 35, 'date_start': date(2022, 7, 1), 'date_end': date(2022, 7, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_team_work').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            {'description': 'Indemnité travail par équipes', 'monthly_amount': 105, 'total_amount': 105, 'date_start': date(2022, 8, 1), 'date_end': date(2022, 8, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_team_work').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            {'description': 'Indemnité travail par équipes', 'monthly_amount': 89, 'total_amount': 89, 'date_start': date(2022, 9, 1), 'date_end': date(2022, 9, 30), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_team_work').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            {'description': 'Indemnité travail par équipes', 'monthly_amount': 81, 'total_amount': 81, 'date_start': date(2022, 10, 1), 'date_end': date(2022, 10, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_team_work').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            {'description': 'Indemnité travail par équipes', 'monthly_amount': 95, 'total_amount': 95, 'date_start': date(2022, 12, 1), 'date_end': date(2022, 12, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_team_work').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            {'description': 'Commission', 'monthly_amount': 2044, 'total_amount': 2044, 'date_start': date(2022, 12, 1), 'date_end': date(2022, 12, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_commission').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            {'description': 'Perte de gain RHT/ITP (SH)', 'monthly_amount': 3000, 'total_amount': 6000, 'date_start': date(2022, 2, 1), 'date_end': date(2022, 3, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_indemnite_perte_de_gain').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            {'description': 'Indemnité de chômage', 'monthly_amount': 2200, 'total_amount': 4400, 'date_start': date(2022, 2, 1), 'date_end': date(2022, 3, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_indemnite_chomage').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            {'description': 'Délai de carence RHT/ITP', 'monthly_amount': 200, 'total_amount': 400, 'date_start': date(2022, 2, 1), 'date_end': date(2022, 3, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_delai_carence_rht_itp').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            {'description': 'Allocation pour enfant', 'monthly_amount': 200, 'total_amount': 2800, 'date_start': date(2022, 1, 1), 'date_end': date(2023, 2, 28), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_child_allowance').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            # TF03
            {'description': 'Indemnité spéciale', 'monthly_amount': 3200, 'total_amount': 6400, 'date_start': date(2022, 2, 1), 'date_end': date(2022, 3, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_special_indemnity').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf03'].id)]},
            {'description': 'Cadeau pour ancienneté de service', 'monthly_amount': 22000, 'total_amount': 22000, 'date_start': date(2022, 2, 1), 'date_end': date(2022, 2, 28), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_jubilee_gift').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf03'].id)]},
            {'description': 'Prestation en capital à caractère de prévoyance', 'monthly_amount': 6000, 'total_amount': 6000, 'date_start': date(2022, 2, 1), 'date_end': date(2022, 2, 28), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_pension_capital').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf03'].id)]},
            {'description': 'Cotisation LPP', 'monthly_amount': 385, 'total_amount': 770, 'date_start': date(2022, 1, 1), 'date_end': date(2022, 2, 28), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_lpp').id, 'is_refund': True, 'employee_ids': [(4, mapped_employees['employee_tf03'].id)]},
            # TF04
            {'description': '14ème salaire', 'monthly_amount': 30000, 'total_amount': 30000, 'date_start': date(2022, 12, 1), 'date_end': date(2022, 12, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_14th_month').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf04'].id)]},
            {'description': 'Cadeau pour ancienneté de service', 'monthly_amount': 40000, 'total_amount': 80000, 'date_start': date(2023, 1, 1), 'date_end': date(2023, 2, 28), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_jubilee_gift').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf04'].id)]},
            {'description': 'Cotisation LPP', 'monthly_amount': 2450, 'total_amount': 29400, 'date_start': date(2022, 1, 1), 'date_end': date(2022, 12, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_lpp').id, 'is_refund': True, 'employee_ids': [(4, mapped_employees['employee_tf04'].id)]},
            # TF05
            {'description': 'Indemnité de dimanche', 'monthly_amount': 6000, 'total_amount': 12000, 'date_start': date(2023, 1, 1), 'date_end': date(2023, 2, 28), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_sunday_allowance').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf05'].id)]},
            {'description': 'Indemnité journalière accident', 'monthly_amount': 10000, 'total_amount': 20000, 'date_start': date(2023, 1, 1), 'date_end': date(2023, 2, 28), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_indemnity_accident').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf05'].id)]},
            {'description': 'Correction indemnité de tiers', 'monthly_amount': 10000, 'total_amount': 20000, 'date_start': date(2023, 1, 1), 'date_end': date(2023, 2, 28), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_third_party_correction').id, 'is_refund': True, 'employee_ids': [(4, mapped_employees['employee_tf05'].id)]},
            {'description': 'Cotisation LPP', 'monthly_amount': 102, 'total_amount': 408, 'date_start': date(2022, 1, 1), 'date_end': date(2022, 4, 30), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_lpp').id, 'is_refund': True, 'employee_ids': [(4, mapped_employees['employee_tf05'].id)]},
            # TF06
            {'description': 'Indemnité APG', 'monthly_amount': 4800, 'total_amount': 9600, 'date_start': date(2023, 1, 1), 'date_end': date(2023, 2, 28), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_indemnity_apg').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf06'].id)]},
            {'description': 'Indemnité journalière accident', 'monthly_amount': 15200, 'total_amount': 30400, 'date_start': date(2023, 1, 1), 'date_end': date(2023, 2, 28), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_indemnity_accident').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf06'].id)]},
            {'description': 'Correction indemnité de tiers', 'monthly_amount': 20000, 'total_amount': 40000, 'date_start': date(2023, 1, 1), 'date_end': date(2023, 2, 28), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_third_party_correction').id, 'is_refund': True, 'employee_ids': [(4, mapped_employees['employee_tf06'].id)]},
            {'description': 'Cotisation LPP', 'monthly_amount': 945, 'total_amount': 9450, 'date_start': date(2022, 1, 1), 'date_end': date(2022, 10, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_lpp').id, 'is_refund': True, 'employee_ids': [(4, mapped_employees['employee_tf06'].id)]},
            # TF 07
            {'description': 'Heures supplémentaires après le départ', 'monthly_amount': 15000, 'total_amount': 15000, 'date_start': date(2022, 1, 1), 'date_end': date(2022, 1, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_overtime_after_departure').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf07'].id)]},
            {'description': 'Indemnité journalière accident', 'monthly_amount': 9500, 'total_amount': 9500, 'date_start': date(2022, 2, 1), 'date_end': date(2022, 2, 28), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_indemnity_accident').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf07'].id)]},
            {'description': 'Correction indemnité de tiers', 'monthly_amount': 9500, 'total_amount': 9500, 'date_start': date(2022, 2, 1), 'date_end': date(2022, 2, 28), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_third_party_correction').id, 'is_refund': True, 'employee_ids': [(4, mapped_employees['employee_tf07'].id)]},
            {'description': 'Cotisation LPP', 'monthly_amount': 560, 'total_amount': 1120, 'date_start': date(2021, 11, 1), 'date_end': date(2021, 12, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_lpp').id, 'is_refund': True, 'employee_ids': [(4, mapped_employees['employee_tf07'].id)]},
            # TF08
            {'description': 'Salaire horaire', 'monthly_amount': 170.0, 'total_amount': 2040.0, 'date_start': date(2022, 1, 1), 'date_end': date(2022, 12, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf08'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 350.0, 'total_amount': 350.0, 'date_start': date(2023, 2, 1), 'date_end': date(2023, 2, 28), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf08'].id)]},
            {'description': 'Indemnité travail par équipes', 'monthly_amount': 25, 'total_amount': 25, 'date_start': date(2022, 3, 1), 'date_end': date(2022, 3, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_team_work').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf08'].id)]},
            {'description': 'Indemnité travail par équipes', 'monthly_amount': 35, 'total_amount': 35, 'date_start': date(2022, 4, 1), 'date_end': date(2022, 4, 30), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_team_work').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf08'].id)]},
            {'description': 'Indemnité travail par équipes', 'monthly_amount': 40, 'total_amount': 40, 'date_start': date(2022, 5, 1), 'date_end': date(2022, 5, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_team_work').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf08'].id)]},
            {'description': 'Indemnité travail par équipes', 'monthly_amount': 35, 'total_amount': 35, 'date_start': date(2022, 7, 1), 'date_end': date(2022, 7, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_team_work').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf08'].id)]},
            {'description': 'Indemnité travail par équipes', 'monthly_amount': 105, 'total_amount': 105, 'date_start': date(2022, 8, 1), 'date_end': date(2022, 8, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_team_work').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf08'].id)]},
            {'description': 'Indemnité travail par équipes', 'monthly_amount': 89, 'total_amount': 89, 'date_start': date(2022, 9, 1), 'date_end': date(2022, 9, 30), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_team_work').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf08'].id)]},
            {'description': 'Indemnité travail par équipes', 'monthly_amount': 81, 'total_amount': 81, 'date_start': date(2022, 10, 1), 'date_end': date(2022, 10, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_team_work').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf08'].id)]},
            {'description': 'Indemnité travail par équipes', 'monthly_amount': 44, 'total_amount': 44, 'date_start': date(2022, 11, 1), 'date_end': date(2022, 11, 30), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_team_work').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf08'].id)]},
            {'description': 'Indemnité travail par équipes', 'monthly_amount': 95, 'total_amount': 95, 'date_start': date(2022, 12, 1), 'date_end': date(2022, 12, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_team_work').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf08'].id)]},
            {'description': 'Indemnité travail par équipes', 'monthly_amount': 44, 'total_amount': 44, 'date_start': date(2023, 2, 1), 'date_end': date(2023, 2, 28), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_team_work').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf08'].id)]},
            {'description': 'Indemnité de dimanche', 'monthly_amount': 20000, 'total_amount': 20000, 'date_start': date(2023, 1, 1), 'date_end': date(2023, 1, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_sunday_allowance').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf08'].id)]},
            {'description': 'Commission', 'monthly_amount': 2044, 'total_amount': 2044, 'date_start': date(2022, 12, 1), 'date_end': date(2022, 12, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_commission').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf08'].id)]},
            {'description': 'Allocation pour enfant', 'monthly_amount': 230, 'total_amount': 2760, 'date_start': date(2022, 1, 1), 'date_end': date(2022, 12, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_child_allowance').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf08'].id)]},
            {'description': 'Cotisation LPP', 'monthly_amount': 724, 'total_amount': 8688, 'date_start': date(2022, 1, 1), 'date_end': date(2022, 12, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_lpp').id, 'is_refund': True, 'employee_ids': [(4, mapped_employees['employee_tf08'].id)]},
            # TF09
            {'description': 'Gratification', 'monthly_amount': 1700, 'total_amount': 1700, 'date_start': date(2022, 11, 1), 'date_end': date(2022, 11, 30), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_gratification').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf09'].id)]},
            {'description': 'Gratification', 'monthly_amount': 200, 'total_amount': 200, 'date_start': date(2022, 12, 1), 'date_end': date(2022, 12, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_gratification').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf09'].id)]},
            {'description': 'Indemnité spéciale', 'monthly_amount': 35000, 'total_amount': 35000, 'date_start': date(2022, 3, 1), 'date_end': date(2022, 3, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_special_indemnity').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf09'].id)]},
            {'description': 'Indemnité journalière accident', 'monthly_amount': 30000, 'total_amount': 30000, 'date_start': date(2022, 10, 1), 'date_end': date(2022, 10, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_indemnity_accident').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf09'].id)]},
            {'description': 'Indemnité journalière accident', 'monthly_amount': 32000, 'total_amount': 32000, 'date_start': date(2022, 12, 1), 'date_end': date(2022, 12, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_indemnity_accident').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf09'].id)]},
            {'description': 'Correction indemnité de tiers', 'monthly_amount': 30000, 'total_amount': 30000, 'date_start': date(2022, 10, 1), 'date_end': date(2022, 10, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_third_party_correction').id, 'is_refund': True, 'employee_ids': [(4, mapped_employees['employee_tf09'].id)]},
            {'description': 'Correction indemnité de tiers', 'monthly_amount': 32000, 'total_amount': 32000, 'date_start': date(2022, 12, 1), 'date_end': date(2022, 12, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_third_party_correction').id, 'is_refund': True, 'employee_ids': [(4, mapped_employees['employee_tf09'].id)]},
            # TF10
            {'description': 'Heures supplémentaires 125%', 'monthly_amount': 1200, 'total_amount': 1200, 'date_start': date(2022, 12, 1), 'date_end': date(2022, 12, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_overtime_125').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf10'].id)]},
            {'description': 'Indemnité spéciale', 'monthly_amount': 31000, 'total_amount': 31000, 'date_start': date(2022, 9, 1), 'date_end': date(2022, 9, 30), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_special_indemnity').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf10'].id)]},
            {'description': 'Indemnité spéciale', 'monthly_amount': 7000, 'total_amount': 7000, 'date_start': date(2022, 12, 1), 'date_end': date(2022, 12, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_special_indemnity').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf10'].id)]},
            {'description': 'Indemnité APG', 'monthly_amount': 1000, 'total_amount': 1000, 'date_start': date(2022, 2, 1), 'date_end': date(2022, 2, 28), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_indemnity_apg').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf10'].id)]},
            {'description': 'Prestation compensation mil. (CCM)', 'monthly_amount': 800, 'total_amount': 800, 'date_start': date(2022, 2, 1), 'date_end': date(2022, 2, 28), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_military_wage').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf10'].id)]},
            {'description': 'Indemnité journalière accident', 'monthly_amount': 2000, 'total_amount': 2000, 'date_start': date(2022, 9, 1), 'date_end': date(2022, 9, 30), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_indemnity_accident').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf10'].id)]},
            {'description': 'Indemnité maladie', 'monthly_amount': 2500, 'total_amount': 2500, 'date_start': date(2022, 9, 1), 'date_end': date(2022, 9, 30), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_indemnity_illness').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf10'].id)]},
            {'description': 'Correction indemnité de tiers', 'monthly_amount': 1800, 'total_amount': 1800, 'date_start': date(2022, 2, 1), 'date_end': date(2022, 2, 28), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_third_party_correction').id, 'is_refund': True, 'employee_ids': [(4, mapped_employees['employee_tf10'].id)]},
            {'description': 'Correction indemnité de tiers', 'monthly_amount': 4500, 'total_amount': 4500, 'date_start': date(2022, 9, 1), 'date_end': date(2022, 9, 30), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_third_party_correction').id, 'is_refund': True, 'employee_ids': [(4, mapped_employees['employee_tf10'].id)]},
            {'description': 'Déduction RHT/ITP (SM)', 'monthly_amount': 3000, 'total_amount': 3000, 'date_start': date(2022, 3, 1), 'date_end': date(2022, 3, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_ded_rht_itp').id, 'is_refund': True, 'employee_ids': [(4, mapped_employees['employee_tf10'].id)]},
            {'description': 'Versement salaire après décès', 'monthly_amount': 6400, 'total_amount': 12800, 'date_start': date(2022, 11, 1), 'date_end': date(2022, 12, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_dead_alw').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf10'].id)]},
            {'description': 'Indemnité de chômage', 'monthly_amount': 2200, 'total_amount': 2200, 'date_start': date(2022, 3, 1), 'date_end': date(2022, 3, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_indemnite_chomage').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf10'].id)]},
            {'description': 'Délai de carence RHT/ITP', 'monthly_amount': 200, 'total_amount': 200, 'date_start': date(2022, 3, 1), 'date_end': date(2022, 3, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_delai_carence_rht_itp').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf10'].id)]},
            {'description': 'Cotisation LPP', 'monthly_amount': 448, 'total_amount': 4032, 'date_start': date(2022, 2, 1), 'date_end': date(2022, 10, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_lpp').id, 'is_refund': True, 'employee_ids': [(4, mapped_employees['employee_tf10'].id)]},
            # TF11
            {'description': 'Honoraires', 'monthly_amount': 20000, 'total_amount': 20000, 'date_start': date(2022, 10, 1), 'date_end': date(2022, 10, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_fee_ch').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf11'].id)]},
            {'description': 'Honoraires', 'monthly_amount': 15000, 'total_amount': 15000, 'date_start': date(2022, 11, 1), 'date_end': date(2022, 11, 30), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_fee_ch').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf11'].id)]},
            {'description': 'Indemnité de résidence', 'monthly_amount': 500, 'total_amount': 7000, 'date_start': date(2022, 1, 1), 'date_end': date(2023, 2, 28), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_overtime_house_allowance').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf11'].id)]},
            {'description': 'Gratification', 'monthly_amount': 5000, 'total_amount': 5000, 'date_start': date(2022, 4, 1), 'date_end': date(2022, 4, 30), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_gratification').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf11'].id)]},
            {'description': 'Indemnité spéciale', 'monthly_amount': 3400, 'total_amount': 3400, 'date_start': date(2022, 4, 1), 'date_end': date(2022, 4, 30), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_special_indemnity').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf11'].id)]},
            {'description': 'Indemnité spéciale', 'monthly_amount': 1200, 'total_amount': 1200, 'date_start': date(2022, 7, 1), 'date_end': date(2022, 7, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_special_indemnity').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf11'].id)]},
            {'description': 'Indemnité spéciale', 'monthly_amount': 500, 'total_amount': 500, 'date_start': date(2022, 10, 1), 'date_end': date(2022, 10, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_special_indemnity').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf11'].id)]},
            {'description': 'Prestation en capital à caractère de prévoyance', 'monthly_amount': 50000, 'total_amount': 50000, 'date_start': date(2022, 5, 1), 'date_end': date(2022, 5, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_pension_capital').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf11'].id)]},
            {'description': 'Part privée voiture de service', 'monthly_amount': 250, 'total_amount': 3500, 'date_start': date(2022, 1, 1), 'date_end': date(2023, 2, 28), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_company_car').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf11'].id)]},
            {'description': 'Réduction loyer logement locatif', 'monthly_amount': 1200, 'total_amount': 16800, 'date_start': date(2022, 1, 1), 'date_end': date(2023, 2, 28), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_overtime_rental_housing').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf11'].id)]},
            {'description': 'Actions de collaborateurs', 'monthly_amount': 20000, 'total_amount': 20000, 'date_start': date(2022, 3, 1), 'date_end': date(2022, 3, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_action_collab').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf11'].id)]},
            {'description': 'Actions de collaborateurs', 'monthly_amount': 20000, 'total_amount': 20000, 'date_start': date(2022, 6, 1), 'date_end': date(2022, 6, 30), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_action_collab').id, 'is_refund': True, 'employee_ids': [(4, mapped_employees['employee_tf11'].id)]},
            {'description': 'Part facultative employeurs rachat LPP', 'monthly_amount': 5000, 'total_amount': 5000, 'date_start': date(2022, 3, 1), 'date_end': date(2022, 3, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_optional_lpp_redemption').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf11'].id)]},
            {'description': 'Allocation pour enfant', 'monthly_amount': 250, 'total_amount': 500, 'date_start': date(2022, 1, 1), 'date_end': date(2022, 2, 28), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_child_allowance').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf11'].id)]},
            {'description': 'Allocation pour enfant', 'monthly_amount': 450, 'total_amount': 3600, 'date_start': date(2022, 3, 1), 'date_end': date(2022, 10, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_child_allowance').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf11'].id)]},
            {'description': 'Allocation pour enfant', 'monthly_amount': 200, 'total_amount': 800, 'date_start': date(2022, 11, 1), 'date_end': date(2023, 2, 28), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_child_allowance').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf11'].id)]},
            {'description': 'Allocation de naissance', 'monthly_amount': 1000, 'total_amount': 1000, 'date_start': date(2022, 3, 1), 'date_end': date(2022, 3, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_birth_allowance').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf11'].id)]},
            {'description': 'Cotisation LPP', 'monthly_amount': 763, 'total_amount': 3815, 'date_start': date(2022, 1, 1), 'date_end': date(2022, 5, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_lpp').id, 'is_refund': True, 'employee_ids': [(4, mapped_employees['employee_tf11'].id)]},
            {'description': 'Cotisation LPP', 'monthly_amount': 2514, 'total_amount': 22626, 'date_start': date(2022, 6, 1), 'date_end': date(2023, 2, 28), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_lpp').id, 'is_refund': True, 'employee_ids': [(4, mapped_employees['employee_tf11'].id)]},
            {'description': 'Correction prestations en nature', 'monthly_amount': 1200, 'total_amount': 16800, 'date_start': date(2022, 1, 1), 'date_end': date(2023, 2, 28), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_action_bik_correction').id, 'is_refund': True, 'employee_ids': [(4, mapped_employees['employee_tf11'].id)]},
            {'description': 'Correction avantage en argent', 'monthly_amount': 250, 'total_amount': 500, 'date_start': date(2022, 1, 1), 'date_end': date(2022, 2, 28), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_action_cash_correction').id, 'is_refund': True, 'employee_ids': [(4, mapped_employees['employee_tf11'].id)]},
            {'description': 'Correction avantage en argent', 'monthly_amount': 20250, 'total_amount': 20250, 'date_start': date(2022, 3, 1), 'date_end': date(2022, 3, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_action_cash_correction').id, 'is_refund': True, 'employee_ids': [(4, mapped_employees['employee_tf11'].id)]},
            {'description': 'Correction avantage en argent', 'monthly_amount': 250, 'total_amount': 500, 'date_start': date(2022, 4, 1), 'date_end': date(2022, 5, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_action_cash_correction').id, 'is_refund': True, 'employee_ids': [(4, mapped_employees['employee_tf11'].id)]},
            {'description': 'Correction avantage en argent', 'monthly_amount': 19750, 'total_amount': 19750, 'date_start': date(2022, 6, 1), 'date_end': date(2022, 6, 30), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_action_cash_correction').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf11'].id)]},
            {'description': 'Correction avantage en argent', 'monthly_amount': 250, 'total_amount': 2000, 'date_start': date(2022, 7, 1), 'date_end': date(2023, 2, 28), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_action_cash_correction').id, 'is_refund': True, 'employee_ids': [(4, mapped_employees['employee_tf11'].id)]},
            # TF12
            {'employee_ids': [(4, mapped_employees['employee_tf12'].id)], 'monthly_amount': 1000, 'total_amount': 1000, 'date_start': date(2022, 10, 1), 'date_end': date(2022, 10, 31), 'description': 'Commission', 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_commission').id, 'is_refund': False},
            {'employee_ids': [(4, mapped_employees['employee_tf12'].id)], 'monthly_amount': 10000, 'total_amount': 10000, 'date_start': date(2022, 11, 1), 'date_end': date(2022, 11, 30), 'description': 'Commission', 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_commission').id, 'is_refund': False},
            {'employee_ids': [(4, mapped_employees['employee_tf12'].id)], 'monthly_amount': 25000, 'total_amount': 25000, 'date_start': date(2022, 12, 1), 'date_end': date(2022, 12, 31), 'description': 'Commission', 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_commission').id, 'is_refund': False},
            {'employee_ids': [(4, mapped_employees['employee_tf12'].id)], 'monthly_amount': 200, 'total_amount': 1600, 'date_start': date(2022, 2, 1), 'date_end': date(2022, 9, 30), 'description': 'Repas gratuit', 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_free_meals').id, 'is_refund': False},
            {'employee_ids': [(4, mapped_employees['employee_tf12'].id)], 'monthly_amount': 650, 'total_amount': 5200, 'date_start': date(2022, 2, 1), 'date_end': date(2022, 9, 30), 'description': 'Logement gratuit', 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_free_housing').id, 'is_refund': False},
            {'employee_ids': [(4, mapped_employees['employee_tf12'].id)], 'monthly_amount': 7000, 'total_amount': 7000, 'date_start': date(2022, 8, 1), 'date_end': date(2022, 8, 31), 'description': 'Options de collaborateurs', 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_optcollab').id, 'is_refund': False},
            {'employee_ids': [(4, mapped_employees['employee_tf12'].id)], 'monthly_amount': 2000, 'total_amount': 2000, 'date_start': date(2022, 3, 1), 'date_end': date(2022, 3, 31), 'description': 'Perfectionnement (certificat de salaire)', 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_improv').id, 'is_refund': False},
            {'employee_ids': [(4, mapped_employees['employee_tf12'].id)], 'monthly_amount': 2000, 'total_amount': 2000, 'date_start': date(2022, 6, 1), 'date_end': date(2022, 6, 30), 'description': 'Indemnité APG', 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_indemnity_apg').id, 'is_refund': False},
            {'employee_ids': [(4, mapped_employees['employee_tf12'].id)], 'monthly_amount': 1500, 'total_amount': 1500, 'date_start': date(2022, 6, 1), 'date_end': date(2022, 6, 30), 'description': 'Prestation compensation mil. (CCM)', 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_military_wage').id, 'is_refund': False},
            {'employee_ids': [(4, mapped_employees['employee_tf12'].id)], 'monthly_amount': 3000, 'total_amount': 3000, 'date_start': date(2022, 6, 1), 'date_end': date(2022, 6, 30), 'description': 'Indemnité journalière accident', 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_indemnity_accident').id, 'is_refund': False},
            {'employee_ids': [(4, mapped_employees['employee_tf12'].id)], 'monthly_amount': 6500, 'total_amount': 6500, 'date_start': date(2022, 6, 1), 'date_end': date(2022, 6, 30), 'description': 'Correction indemnité de tiers', 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_third_party_correction').id, 'is_refund': True},
            {'employee_ids': [(4, mapped_employees['employee_tf12'].id)], 'monthly_amount': 840, 'total_amount': 9240, 'date_start': date(2022, 2, 1), 'date_end': date(2022, 12, 31), 'description': 'Cotisation LPP', 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_lpp').id, 'is_refund': True},
            {'employee_ids': [(4, mapped_employees['employee_tf12'].id)], 'monthly_amount': 850, 'total_amount': 6800, 'date_start': date(2022, 2, 1), 'date_end': date(2022, 9, 30), 'description': 'Correction prestations en nature', 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_action_bik_correction').id, 'is_refund': True},
            {'employee_ids': [(4, mapped_employees['employee_tf12'].id)], 'monthly_amount': 7000, 'total_amount': 7000, 'date_start': date(2022, 8, 1), 'date_end': date(2022, 8, 31), 'description': 'Correction avantage en argent', 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_action_cash_correction').id, 'is_refund': True},
            {'employee_ids': [(4, mapped_employees['employee_tf12'].id)], 'monthly_amount': 1000, 'total_amount': 8000, 'date_start': date(2022, 2, 1), 'date_end': date(2022, 9, 30), 'description': 'Frais effectifs expatriés', 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_effective_expatriate_costs').id, 'is_refund': False},
            {'employee_ids': [(4, mapped_employees['employee_tf12'].id)], 'monthly_amount': 800, 'total_amount': 2400, 'date_start': date(2022, 10, 1), 'date_end': date(2022, 12, 31), 'description': 'Frais forfaitaires de voiture', 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_car_fees').id, 'is_refund': False},
            {'employee_ids': [(4, mapped_employees['employee_tf12'].id)], 'monthly_amount': 300, 'total_amount': 900, 'date_start': date(2022, 10, 1), 'date_end': date(2022, 12, 31), 'description': 'Autres frais forfaitaires', 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_other_fees').id, 'is_refund': False},
            # TF13
            {'description': 'Indemnité de résidence', 'monthly_amount': 200, 'total_amount': 2800, 'date_start': date(2022, 1, 1), 'date_end': date(2023, 2, 28), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_overtime_house_allowance').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf13'].id)]},
            {'description': 'Heures supplémentaires', 'monthly_amount': 180, 'total_amount': 180, 'date_start': date(2022, 4, 1), 'date_end': date(2022, 4, 30), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_overtime100').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf13'].id)]},
            {'description': 'Heures supplémentaires', 'monthly_amount': 300, 'total_amount': 300, 'date_start': date(2022, 7, 1), 'date_end': date(2022, 7, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_overtime100').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf13'].id)]},
            {'description': 'Heures supplémentaires', 'monthly_amount': 80, 'total_amount': 80, 'date_start': date(2022, 11, 1), 'date_end': date(2022, 11, 30), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_overtime100').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf13'].id)]},
            {'description': 'Heures supplémentaires', 'monthly_amount': 250, 'total_amount': 250, 'date_start': date(2022, 12, 1), 'date_end': date(2022, 12, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_overtime100').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf13'].id)]},
            {'description': 'Commission', 'monthly_amount': 1000, 'total_amount': 1000, 'date_start': date(2022, 12, 1), 'date_end': date(2022, 12, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_commission').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf13'].id)]},
            {'description': 'Allocation pour enfant', 'monthly_amount': 200, 'total_amount': 400, 'date_start': date(2023, 1, 1), 'date_end': date(2023, 2, 28), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_child_allowance').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf13'].id)]},
            {'description': 'Frais de voyage', 'monthly_amount': 500, 'total_amount': 5500, 'date_start': date(2022, 4, 1), 'date_end': date(2023, 2, 28), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_travel_expense').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf13'].id)]},
            # TF14
            {'description': 'Salaire horaire', 'monthly_amount': 75.0, 'total_amount': 75.0, 'date_start': date(2021, 11, 1), 'date_end': date(2021, 11, 30), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf14'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 130.0, 'total_amount': 130.0, 'date_start': date(2021, 12, 1), 'date_end': date(2021, 12, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf14'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 120.0, 'total_amount': 120.0, 'date_start': date(2022, 1, 1), 'date_end': date(2022, 1, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf14'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 115.0, 'total_amount': 115.0, 'date_start': date(2022, 2, 1), 'date_end': date(2022, 2, 28), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf14'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 160.0, 'total_amount': 160.0, 'date_start': date(2022, 3, 1), 'date_end': date(2022, 3, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf14'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 95.0, 'total_amount': 95.0, 'date_start': date(2022, 4, 1), 'date_end': date(2022, 4, 30), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf14'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 140.0, 'total_amount': 280.0, 'date_start': date(2022, 5, 1), 'date_end': date(2022, 6, 30), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf14'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 125.0, 'total_amount': 125.0, 'date_start': date(2022, 7, 1), 'date_end': date(2022, 7, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf14'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 170.0, 'total_amount': 170.0, 'date_start': date(2022, 8, 1), 'date_end': date(2022, 8, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf14'].id)]},
            {'description': 'Options de collaborateurs', 'monthly_amount': 10000, 'total_amount': 10000, 'date_start': date(2022, 10, 1), 'date_end': date(2022, 10, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_optcollab').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf14'].id)]},
            {'description': 'Correction avantage en argent', 'monthly_amount': 10000, 'total_amount': 10000, 'date_start': date(2022, 10, 1), 'date_end': date(2022, 10, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_action_cash_correction').id, 'is_refund': True, 'employee_ids': [(4, mapped_employees['employee_tf14'].id)]},
            {'description': 'Frais de voyage', 'monthly_amount': 200, 'total_amount': 3200, 'date_start': date(2021, 11, 1), 'date_end': date(2023, 2, 28), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_travel_expense').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf14'].id)]},
            # TF15
            {'description': 'Salaire à la leçon', 'monthly_amount': 21, 'total_amount': 21, 'date_start': date(2022, 3, 1), 'date_end': date(2022, 3, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_salary_lesson').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf15'].id)]},
            {'description': 'Frais de voyage', 'monthly_amount': 257.5, 'total_amount': 257.5, 'date_start': date(2022, 3, 1), 'date_end': date(2022, 3, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_travel_expense').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf15'].id)]},
            # TF16
            {'employee_ids': [(4, mapped_employees['employee_tf16'].id)], 'monthly_amount': 9458.35, 'total_amount': 9458.35, 'date_start': date(2021, 11, 1), 'date_end': date(2021, 11, 30), 'description': 'Honoraires', 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_fee_ch').id, 'is_refund': False},
            {'employee_ids': [(4, mapped_employees['employee_tf16'].id)], 'monthly_amount': 8895, 'total_amount': 8895, 'date_start': date(2021, 12, 1), 'date_end': date(2021, 12, 31), 'description': 'Honoraires', 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_fee_ch').id, 'is_refund': False},
            {'employee_ids': [(4, mapped_employees['employee_tf16'].id)], 'monthly_amount': 14350.6, 'total_amount': 14350.6, 'date_start': date(2022, 2, 1), 'date_end': date(2022, 2, 28), 'description': 'Honoraires', 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_fee_ch').id, 'is_refund': False},
            {'employee_ids': [(4, mapped_employees['employee_tf16'].id)], 'monthly_amount': 10214.45, 'total_amount': 10214.45, 'date_start': date(2022, 3, 1), 'date_end': date(2022, 3, 31), 'description': 'Honoraires', 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_fee_ch').id, 'is_refund': False},
            {'employee_ids': [(4, mapped_employees['employee_tf16'].id)], 'monthly_amount': 3000, 'total_amount': 3000, 'date_start': date(2021, 11, 1), 'date_end': date(2021, 11, 30), 'description': 'Indemnité spéciale', 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_special_indemnity').id, 'is_refund': False},
            {'employee_ids': [(4, mapped_employees['employee_tf16'].id)], 'monthly_amount': 5000, 'total_amount': 5000, 'date_start': date(2022, 2, 1), 'date_end': date(2022, 2, 28), 'description': 'Indemnité spéciale', 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_special_indemnity').id, 'is_refund': False},
            {'employee_ids': [(4, mapped_employees['employee_tf16'].id)], 'monthly_amount': 4000, 'total_amount': 4000, 'date_start': date(2022, 3, 1), 'date_end': date(2022, 3, 31), 'description': 'Indemnité spéciale', 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_special_indemnity').id, 'is_refund': False},
            {'employee_ids': [(4, mapped_employees['employee_tf16'].id)], 'monthly_amount': 250, 'total_amount': 250, 'date_start': date(2021, 12, 1), 'date_end': date(2021, 12, 31), 'description': 'Part facultative employeurs IJM', 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_optional_ijm').id, 'is_refund': False},
            {'employee_ids': [(4, mapped_employees['employee_tf16'].id)], 'monthly_amount': 150, 'total_amount': 300, 'date_start': date(2021, 11, 1), 'date_end': date(2021, 12, 31), 'description': '3ème pilier b payé par employeur', 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_thirdpillb').id, 'is_refund': False},
            {'employee_ids': [(4, mapped_employees['employee_tf16'].id)], 'monthly_amount': 150, 'total_amount': 300, 'date_start': date(2022, 2, 1), 'date_end': date(2022, 3, 31), 'description': '3ème pilier b payé par employeur', 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_thirdpillb').id, 'is_refund': False},
            {'employee_ids': [(4, mapped_employees['employee_tf16'].id)], 'monthly_amount': 350, 'total_amount': 700, 'date_start': date(2021, 11, 1), 'date_end': date(2021, 12, 31), 'description': '3ème pilier a payé par employeur', 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_thirdpilla').id, 'is_refund': False},
            {'employee_ids': [(4, mapped_employees['employee_tf16'].id)], 'monthly_amount': 350, 'total_amount': 700, 'date_start': date(2022, 2, 1), 'date_end': date(2022, 3, 31), 'description': '3ème pilier a payé par employeur', 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_thirdpilla').id, 'is_refund': False},
            {'employee_ids': [(4, mapped_employees['employee_tf16'].id)], 'monthly_amount': 500, 'total_amount': 500, 'date_start': date(2021, 11, 1), 'date_end': date(2021, 11, 30), 'description': 'Correction avantage en argent', 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_action_cash_correction').id, 'is_refund': True},
            {'employee_ids': [(4, mapped_employees['employee_tf16'].id)], 'monthly_amount': 750, 'total_amount': 750, 'date_start': date(2021, 12, 1), 'date_end': date(2021, 12, 31), 'description': 'Correction avantage en argent', 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_action_cash_correction').id, 'is_refund': True},
            {'employee_ids': [(4, mapped_employees['employee_tf16'].id)], 'monthly_amount': 500, 'total_amount': 1000, 'date_start': date(2022, 2, 1), 'date_end': date(2022, 3, 31), 'description': 'Correction avantage en argent', 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_action_cash_correction').id, 'is_refund': True},
            {'employee_ids': [(4, mapped_employees['employee_tf16'].id)], 'monthly_amount': 300, 'total_amount': 600, 'date_start': date(2021, 11, 1), 'date_end': date(2021, 12, 31), 'description': 'Frais de voyage', 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_travel_expense').id, 'is_refund': False},
            {'employee_ids': [(4, mapped_employees['employee_tf16'].id)], 'monthly_amount': 600, 'total_amount': 600, 'date_start': date(2022, 2, 1), 'date_end': date(2022, 2, 28), 'description': 'Frais de voyage', 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_travel_expense').id, 'is_refund': False},
            {'employee_ids': [(4, mapped_employees['employee_tf16'].id)], 'monthly_amount': 300, 'total_amount': 300, 'date_start': date(2022, 3, 1), 'date_end': date(2022, 3, 31), 'description': 'Frais de voyage', 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_travel_expense').id, 'is_refund': False},
            # TF17
            {'employee_ids': [(4, mapped_employees['employee_tf17'].id)], 'monthly_amount': 2000, 'total_amount': 2000 * 1, 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_bonus').id, 'date_start': date(2022, 11, 1), 'date_end': date(2022, 11, 30), 'description': 'Bonus'},

             # TF18
            {'description': 'Salaire horaire', 'monthly_amount': 35.0, 'total_amount': 280.0, 'date_start': date(2022, 1, 1), 'date_end': date(2022, 8, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf18'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 75, 'total_amount': 75, 'date_start': date(2022, 9, 1), 'date_end': date(2022, 9, 30), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf18'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 62, 'total_amount': 62, 'date_start': date(2022, 10, 1), 'date_end': date(2022, 10, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf18'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 53, 'total_amount': 53, 'date_start': date(2022, 11, 1), 'date_end': date(2022, 11, 30), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf18'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 71, 'total_amount': 71, 'date_start': date(2022, 12, 1), 'date_end': date(2022, 12, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf18'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 35, 'total_amount': 70, 'date_start': date(2023, 1, 1), 'date_end': date(2023, 2, 28), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf18'].id)]},
            {'description': 'Cotisation LPP', 'monthly_amount': 117, 'total_amount': 1638, 'date_start': date(2022, 1, 1), 'date_end': date(2023, 2, 28), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_lpp').id, 'is_refund': True, 'employee_ids': [(4, mapped_employees['employee_tf18'].id)]},
            # TF19
            # TF20
            {'description': 'Indemnité de départ (soumis AVS)', 'monthly_amount': 500, 'total_amount': 500, 'date_start': date(2022, 3, 1), 'date_end': date(2022, 3, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_sevpay').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf20'].id)]},
            # TF21
            {'description': 'Indemnité de départ soumis à l AVS', 'employee_ids': [(4, mapped_employees['employee_tf21'].id)], 'monthly_amount': 500, 'total_amount': 500 * 1, 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_sevpay').id, 'date_start': date(2022, 3, 1), 'date_end': date(2022, 3, 31)},

            # TF22
            {'description': 'Salaire horaire', 'monthly_amount': 130.0, 'total_amount': 130.0, 'date_start': date(2022, 1, 1), 'date_end': date(2022, 1, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf22'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 120.0, 'total_amount': 120.0, 'date_start': date(2022, 2, 1), 'date_end': date(2022, 2, 28), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf22'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 125.0, 'total_amount': 125.0, 'date_start': date(2022, 3, 1), 'date_end': date(2022, 3, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf22'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 135.0, 'total_amount': 135.0, 'date_start': date(2022, 4, 1), 'date_end': date(2022, 4, 30), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf22'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 115.0, 'total_amount': 115.0, 'date_start': date(2022, 5, 1), 'date_end': date(2022, 5, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf22'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 100.0, 'total_amount': 100.0, 'date_start': date(2022, 6, 1), 'date_end': date(2022, 6, 30), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf22'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 140.0, 'total_amount': 140.0, 'date_start': date(2022, 7, 1), 'date_end': date(2022, 7, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf22'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 115.0, 'total_amount': 115.0, 'date_start': date(2022, 8, 1), 'date_end': date(2022, 8, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf22'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 130.0, 'total_amount': 130.0, 'date_start': date(2022, 9, 1), 'date_end': date(2022, 9, 30), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf22'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 90.0, 'total_amount': 90.0, 'date_start': date(2022, 10, 1), 'date_end': date(2022, 10, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf22'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 120.0, 'total_amount': 120.0, 'date_start': date(2022, 11, 1), 'date_end': date(2022, 11, 30), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf22'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 130.0, 'total_amount': 130.0, 'date_start': date(2022, 12, 1), 'date_end': date(2022, 12, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf22'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 40.0, 'total_amount': 40.0, 'date_start': date(2023, 1, 1), 'date_end': date(2023, 1, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf22'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 96.0, 'total_amount': 96.0, 'date_start': date(2023, 2, 1), 'date_end': date(2023, 2, 28), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf22'].id)]},
            {'description': 'Allocation pour enfant', 'monthly_amount': 200, 'total_amount': 200, 'date_start': date(2023, 2, 1), 'date_end': date(2023, 2, 28), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_child_allowance').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf22'].id)]},
            {'description': 'Allocation de naissance', 'monthly_amount': 3000, 'total_amount': 3000, 'date_start': date(2023, 2, 1), 'date_end': date(2023, 2, 28), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_birth_allowance').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf22'].id)]},
            # TF23
            {'description': 'Bonus', 'monthly_amount': 30000, 'total_amount': 30000, 'date_start': date(2022, 2, 1), 'date_end': date(2022, 2, 28), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_bonus').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf23'].id)]},
            {'description': 'Allocation pour enfant', 'monthly_amount': 200, 'total_amount': 600, 'date_start': date(2022, 10, 1), 'date_end': date(2022, 12, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_child_allowance').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf23'].id)]},
            {'description': 'Cotisation LPP', 'monthly_amount': 379, 'total_amount': 4548, 'date_start': date(2022, 1, 1), 'date_end': date(2022, 12, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_lpp').id, 'is_refund': True, 'employee_ids': [(4, mapped_employees['employee_tf23'].id)]},
            # TF24
            {'description': 'Cotisation LPP', 'monthly_amount': 607, 'total_amount': 7284, 'date_start': date(2022, 1, 1), 'date_end': date(2022, 12, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_lpp').id, 'is_refund': True, 'employee_ids': [(4, mapped_employees['employee_tf24'].id)]},
            # TF25
            # TF26
            # TF27
            {'description': 'Bonus', 'monthly_amount': 30000, 'total_amount': 30000, 'date_start': date(2023, 2, 1), 'date_end': date(2023, 2, 28), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_bonus').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf27'].id)]},
            {'description': 'Cotisation LPP', 'monthly_amount': 700, 'total_amount': 5600, 'date_start': date(2022, 5, 1), 'date_end': date(2022, 12, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_lpp').id, 'is_refund': True, 'employee_ids': [(4, mapped_employees['employee_tf27'].id)]},
            {'description': 'Cotisation LPP', 'monthly_amount': 875, 'total_amount': 1750, 'date_start': date(2023, 1, 1), 'date_end': date(2023, 2, 28), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_lpp').id, 'is_refund': True, 'employee_ids': [(4, mapped_employees['employee_tf27'].id)]},
            # TF28
            {'description': 'Heures supplémentaires après le départ', 'monthly_amount': 2000, 'total_amount': 2000, 'date_start': date(2023, 1, 1), 'date_end': date(2023, 1, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_overtime_after_departure').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf28'].id)]},
            {'description': 'Paiement des vacances après le départ', 'monthly_amount': 3000, 'total_amount': 3000, 'date_start': date(2023, 1, 1), 'date_end': date(2023, 1, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_departure').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf28'].id)]},
            {'description': "Paiement de la prime l'année précédente", 'monthly_amount': 15000, 'total_amount': 15000, 'date_start': date(2023, 2, 1), 'date_end': date(2023, 2, 28), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_prevybonus').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf28'].id)]},
            {'description': "Prime pour proposition d'amélioration", 'monthly_amount': 20000, 'total_amount': 20000, 'date_start': date(2022, 2, 1), 'date_end': date(2022, 2, 28), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_impbonus').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf28'].id)]},
            # TF29
            {'description': 'Correction des salaires', 'monthly_amount': 2000, 'total_amount': 2000, 'date_start': date(2023, 1, 1), 'date_end': date(2023, 1, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_salary_correction').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf29'].id)]},
            {'description': 'Heures supplémentaires après le départ', 'monthly_amount': 2000, 'total_amount': 2000, 'date_start': date(2023, 1, 1), 'date_end': date(2023, 1, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_overtime_after_departure').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf29'].id)]},
            {'description': 'Paiement des vacances après le départ', 'monthly_amount': 3000, 'total_amount': 3000, 'date_start': date(2023, 1, 1), 'date_end': date(2023, 1, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_departure').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf29'].id)]},
            {'description': "Paiement de la prime l'année précédente", 'monthly_amount': 15000, 'total_amount': 15000, 'date_start': date(2023, 2, 1), 'date_end': date(2023, 2, 28), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_prevybonus').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf29'].id)]},
            {'description': "Prime pour proposition d'amélioration", 'monthly_amount': 20000, 'total_amount': 20000, 'date_start': date(2022, 2, 1), 'date_end': date(2022, 2, 28), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_impbonus').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf29'].id)]},
            # TF30
            {'description': 'Paiement des vacances', 'monthly_amount': 500, 'total_amount': 500, 'date_start': date(2022, 11, 1), 'date_end': date(2022, 11, 30), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_vacalw').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf30'].id)]},
            {'description': 'Droits de participation imposables', 'monthly_amount': 5500, 'total_amount': 22000, 'date_start': date(2022, 1, 1), 'date_end': date(2022, 4, 30), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_taxpfee').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf30'].id)]},
            # TF31
            # TF32
            {'description': 'Cotisation LPP', 'monthly_amount': 350, 'total_amount': 2100, 'date_start': date(2022, 9, 1), 'date_end': date(2023, 2, 28), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_lpp').id, 'is_refund': True, 'employee_ids': [(4, mapped_employees['employee_tf32'].id)]},
            {'description': 'Montant IS correction', 'monthly_amount': 372, 'total_amount': 372, 'date_start': date(2023, 1, 1), 'date_end': date(2023, 1, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_is_correction').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf32'].id)]},
            # TF33
            {'description': 'Allocation pour enfant', 'monthly_amount': 230, 'total_amount': 1380, 'date_start': date(2022, 7, 1), 'date_end': date(2022, 12, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_child_allowance').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf33'].id)]},
            {'description': 'Paiement pour Allocation pour enfant', 'monthly_amount': 690, 'total_amount': 690, 'date_start': date(2022, 7, 1), 'date_end': date(2022, 7, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_childalwpay').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf33'].id)]},
            # TF34
            {'description': 'Allocation pour enfant', 'monthly_amount': 200, 'total_amount': 1200, 'date_start': date(2022, 7, 1), 'date_end': date(2022, 12, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_child_allowance').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf34'].id)]},
            {'description': 'Paiement pour Allocation pour enfant', 'monthly_amount': 600, 'total_amount': 600, 'date_start': date(2022, 7, 1), 'date_end': date(2022, 7, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_childalwpay').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf34'].id)]},
            # TF35
            {'description': "Paiement de la prime l'année précédente", 'monthly_amount': 30000, 'total_amount': 30000, 'date_start': date(2022, 2, 1), 'date_end': date(2022, 2, 28), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_prevybonus').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf35'].id)]},
            {'description': 'Allocation pour enfant', 'monthly_amount': 230, 'total_amount': 690, 'date_start': date(2022, 10, 1), 'date_end': date(2022, 12, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_child_allowance').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf35'].id)]},
            {'description': 'Cotisation LPP', 'monthly_amount': 379, 'total_amount': 4548, 'date_start': date(2022, 1, 1), 'date_end': date(2022, 12, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_lpp').id, 'is_refund': True, 'employee_ids': [(4, mapped_employees['employee_tf35'].id)]},
            # TF36
            {'description': "Paiement de la prime l'année précédente", 'monthly_amount': 30000, 'total_amount': 30000, 'date_start': date(2022, 2, 1), 'date_end': date(2022, 2, 28), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_prevybonus').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf36'].id)]},
            {'description': 'Allocation pour enfant', 'monthly_amount': 200, 'total_amount': 600, 'date_start': date(2022, 10, 1), 'date_end': date(2022, 12, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_child_allowance').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf36'].id)]},
            # TF37
            {'description': 'Bonus', 'monthly_amount': 2000, 'total_amount': 2000, 'date_start': date(2022, 1, 1), 'date_end': date(2022, 1, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_bonus').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf37'].id)]},
            {'description': 'Allocation pour enfant', 'monthly_amount': 230, 'total_amount': 690, 'date_start': date(2021, 11, 1), 'date_end': date(2022, 1, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_child_allowance').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf37'].id)]},
            {'description': 'Cotisation LPP', 'monthly_amount': 350, 'total_amount': 700, 'date_start': date(2021, 11, 1), 'date_end': date(2021, 12, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_lpp').id, 'is_refund': True, 'employee_ids': [(4, mapped_employees['employee_tf37'].id)]},
            {'description': 'Cotisation LPP', 'monthly_amount': 362, 'total_amount': 362, 'date_start': date(2022, 1, 1), 'date_end': date(2022, 1, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_lpp').id, 'is_refund': True, 'employee_ids': [(4, mapped_employees['employee_tf37'].id)]},
            # TF38
            {'description': 'Commission', 'monthly_amount': 5000, 'total_amount': 5000, 'date_start': date(2022, 3, 1), 'date_end': date(2022, 3, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_commission').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf38'].id)]},
            {'description': 'Commission', 'monthly_amount': 6500, 'total_amount': 6500, 'date_start': date(2022, 6, 1), 'date_end': date(2022, 6, 30), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_commission').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf38'].id)]},
            {'description': 'Commission', 'monthly_amount': 3800, 'total_amount': 3800, 'date_start': date(2022, 9, 1), 'date_end': date(2022, 9, 30), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_commission').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf38'].id)]},
            {'description': 'Commission', 'monthly_amount': 5500, 'total_amount': 5500, 'date_start': date(2022, 12, 1), 'date_end': date(2022, 12, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_commission').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf38'].id)]},
            {'description': 'Frais forfaitaires de voiture', 'monthly_amount': 300, 'total_amount': 3600, 'date_start': date(2022, 1, 1), 'date_end': date(2022, 12, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_car_fees').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf38'].id)]},
            # TF39
            {'description': 'Honoraires CA', 'monthly_amount': 10000, 'total_amount': 10000, 'date_start': date(2022, 4, 1), 'date_end': date(2022, 4, 30), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_ca_fee').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf39'].id)]},
            # TF40
            {'description': 'Indemnité pour service de piquet', 'monthly_amount': 30500, 'total_amount': 30500, 'date_start': date(2022, 12, 1), 'date_end': date(2022, 12, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_oncallalw').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf40'].id)]},
            {'description': 'Indemnité spéciale', 'monthly_amount': 20000, 'total_amount': 20000, 'date_start': date(2022, 2, 1), 'date_end': date(2022, 2, 28), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_special_indemnity').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf40'].id)]},
            {'description': 'Indemnité spéciale', 'monthly_amount': 500, 'total_amount': 500, 'date_start': date(2022, 12, 1), 'date_end': date(2022, 12, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_special_indemnity').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf40'].id)]},
            {'description': 'Honoraires CA', 'monthly_amount': 300, 'total_amount': 300, 'date_start': date(2022, 2, 1), 'date_end': date(2022, 2, 28), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_ca_fee').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf40'].id)]},
            {'description': 'Honoraires CA', 'monthly_amount': 4000, 'total_amount': 4000, 'date_start': date(2022, 3, 1), 'date_end': date(2022, 3, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_ca_fee').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf40'].id)]},
            {'description': 'Honoraires CA', 'monthly_amount': 6150, 'total_amount': 6150, 'date_start': date(2022, 12, 1), 'date_end': date(2022, 12, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_ca_fee').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf40'].id)]},
            {'description': 'Allocation pour enfant', 'monthly_amount': 230, 'total_amount': 690, 'date_start': date(2022, 1, 1), 'date_end': date(2022, 3, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_child_allowance').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf40'].id)]},
            {'description': 'Allocation pour enfant', 'monthly_amount': 300, 'total_amount': 300, 'date_start': date(2022, 10, 1), 'date_end': date(2022, 10, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_child_allowance').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf40'].id)]},
            {'description': 'Allocation pour enfant', 'monthly_amount': 300, 'total_amount': 900, 'date_start': date(2022, 12, 1), 'date_end': date(2023, 2, 28), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_child_allowance').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf40'].id)]},
            {'description': 'Cotisation LPP', 'monthly_amount': 303, 'total_amount': 606, 'date_start': date(2022, 1, 1), 'date_end': date(2022, 2, 28), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_lpp').id, 'is_refund': True, 'employee_ids': [(4, mapped_employees['employee_tf40'].id)]},
            {'description': 'Cotisation LPP', 'monthly_amount': 303, 'total_amount': 303, 'date_start': date(2022, 10, 1), 'date_end': date(2022, 10, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_lpp').id, 'is_refund': True, 'employee_ids': [(4, mapped_employees['employee_tf40'].id)]},
            {'description': 'Cotisation LPP', 'monthly_amount': 303, 'total_amount': 303, 'date_start': date(2022, 12, 1), 'date_end': date(2022, 12, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_lpp').id, 'is_refund': True, 'employee_ids': [(4, mapped_employees['employee_tf40'].id)]},
            {'description': 'Cotisation LPP', 'monthly_amount': 1196, 'total_amount': 2392, 'date_start': date(2023, 1, 1), 'date_end': date(2023, 2, 28), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_lpp').id, 'is_refund': True, 'employee_ids': [(4, mapped_employees['employee_tf40'].id)]},
            # TF41
            {'description': 'Gratification', 'monthly_amount': 20000, 'total_amount': 20000, 'date_start': date(2022, 2, 1), 'date_end': date(2022, 2, 28), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_gratification').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf41'].id)]},
            {'description': 'Cadeau pour ancienneté de service', 'monthly_amount': 30000, 'total_amount': 30000, 'date_start': date(2022, 5, 1), 'date_end': date(2022, 5, 31), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_jubilee_gift').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf41'].id)]},
            # TF42
            {'description': 'Bonus', 'monthly_amount': 30000, 'total_amount': 30000, 'date_start': date(2023, 2, 1), 'date_end': date(2023, 2, 28), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_bonus').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf42'].id)]},
            # TF43
            {'description': 'Bonus', 'monthly_amount': 30000, 'total_amount': 30000, 'date_start': date(2023, 2, 1), 'date_end': date(2023, 2, 28), 'other_input_type_id': self.env.ref('l10n_ch_hr_payroll.input_holiday_bonus').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf43'].id)]},
        ])

        # Generate Contracts
        contracts = self.env['hr.contract'].with_context(tracking_disable=True).create([
            {'name': "Contract For Herz Monica", 'employee_id': mapped_employees['employee_tf01'].id, 'job_id': job_1.id, 'resource_calendar_id': resource_calendar_42_hours_per_week.id, 'contract_type_id': self.env.ref('l10n_ch_hr_payroll.l10n_ch_contract_type_indefiniteSalaryHrs').id, 'company_id': self.id, 'date_generated_from': datetime(2020, 9, 1, 0, 0, 0), 'date_generated_to': datetime(2020, 9, 1, 0, 0, 0), 'structure_type_id': self.env.ref('l10n_ch_hr_payroll.structure_type_employee_ch').id, 'date_start': date(2022, 1, 1), 'date_end': date(2022, 3, 31), 'wage_type': "hourly", 'wage': 0, 'hourly_wage': 50.0, 'l10n_ch_lesson_wage': 50.0, 'state': "open", 'l10n_ch_location_unit_id': location_unit_1.id, 'l10n_ch_social_insurance_id': avs_2.id, 'l10n_ch_accident_insurance_line_id': laa_1.line_ids[0].id, 'l10n_ch_additional_accident_insurance_line_ids': [(4, laac_1.line_ids[1].id)], 'l10n_ch_sickness_insurance_line_ids': [(4, ijm_1.line_ids[2].id)], 'l10n_ch_lpp_insurance_id': lpp_0.id, 'l10n_ch_compensation_fund_id': caf_lu_2.id, 'l10n_ch_thirteen_month': True, 'l10n_ch_yearly_holidays': 20, 'l10n_ch_job_type': 'lowerCadre'},
    ...
    def _l10n_ch_generate_swissdec_demo_payslip(self, contract, date_from, date_to, thirteen_month=False, after_payment=False, ch_days=20, work_days=20, basic=False, as_days=False, thirteen_force=False, compute=False):
        ...
        if ch_days != 20:
            add_inputs.append((0, 0, {
                'input_type_id': self.env.ref('l10n_ch_hr_payroll.input_is_worked_days_in_ch').id,
                'amount': ch_days,
            }))

        if work_days != 20:
            add_inputs.append((0, 0, {
                'input_type_id': self.env.ref('l10n_ch_hr_payroll.input_is_worked_days').id,
                'amount': work_days,
            }))
        if basic:
            add_inputs.append((0, 0, {
                'input_type_id': self.env.ref('l10n_ch_hr_payroll.input_force_monthly_basic').id,
                'amount': basic,
            }))
        if as_days:
            add_inputs.append((0, 0, {
                'input_type_id': self.env.ref('l10n_ch_hr_payroll.input_force_as_days').id,
                'amount': as_days,
            }))
        if thirteen_force:
            add_inputs.append((0, 0, {
                'input_type_id': self.env.ref('l10n_ch_hr_payroll.input_force_thirteen_month').id,
