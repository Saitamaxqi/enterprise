...
class TestPayslipValidation(TestPayslipValidationCommon):
    ...
    def test_regular_payslip_subsidy(self):
        ...
        payslip_results = {'BASIC': 10000.0, 'HOLIDAY_TO_SUB': 0.0, 'GROSS_WITHOUT_HOLIDAY': 10000.0, 'HOLIDAYS_ON_TIME': 0.0, 'SAVINGS_FUND_SALARY_LIMIT': 1300.0, 'SAVINGS_FUND_LIMIT_UMA': 2235.65, 'SAVINGS_FUND_EMPLOYER_ALW': 1300.0, 'GROSS': 10000.0, 'ISR': -770.9, 'SAVINGS_FUND_EMPLOYEE': -1300.0, 'SAVINGS_FUND_EMPLOYER_DED': -1300.0, 'SUBSIDY_CURRENT_MONTH': 437.17, 'SUBSIDY_ADJUSTMENT': 0.0, 'SUBSIDY': 437.17, 'INT_DAY_WAGE_BASE': 702.28, 'INT_DAY_WAGE_OTHER': 0.0, 'INT_DAY_WAGE_COMMISSIONS': 0.0, 'INT_DAY_WAGE': 702.28, 'RISK_IMSS_EMPLOYER': 98.32, 'DIS_FIX_IMSS_EMPLOYER': 646.26, 'DIS_ADD_IMSS_EMPLOYER': 111.76, 'DIS_ADD_IMSS_EMPLOYEE': -40.64, 'DIS_MED_IMSS_EMPLOYER': 206.47, 'DIS_MED_IMSS_EMPLOYEE': -73.74, 'DIS_MON_IMSS_EMPLOYER': 137.65, 'DIS_MON_IMSS_EMPLOYEE': -49.16, 'DIS_LIF_IMSS_EMPLOYER': 344.12, 'DIS_LIF_IMSS_EMPLOYEE': -122.9, 'RETIRE_IMSS_EMPLOYER': 393.28, 'CEAV_IMSS_EMPLOYER': 1262.82, 'CEAV_IMSS_EMPLOYEE': -221.22, 'NURSERY_IMSS_EMPLOYER': 196.64, 'INFONAVIT_IMSS_EMPLOYER': 983.2, 'IMSS_EMPLOYEE_TOTAL': 507.66, 'IMSS_EMPLOYER_TOTAL': 4380.51, 'NET': 7858.61, 'PROVISIONS_CHRISTMAS_BONUS': 1616.44, 'PERIOD_PROVISIONS_CHRISTMAS_BONUS': 1616.44, 'PROVISIONS_HOLIDAY_BONUS': 2243.84, 'PERIOD_PROVISIONS_HOLIDAY_BONUS': 2243.84, 'PROVISIONS_VACATIONS_BONUS': 8975.34, 'PERIOD_PROVISIONS_VACATIONS_BONUS': 8975.34}
        self._validate_payslip(payslip, payslip_results)
