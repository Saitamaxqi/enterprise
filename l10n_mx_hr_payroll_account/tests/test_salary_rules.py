...
class TestPayslipValidation(TestPayslipValidationCommon):
    ...
    def test_christmas_bonus_2(self):
        ...
        self._generate_leave(date(2024, 2, 5), date(2024, 2, 7), self.env.ref('l10n_mx_hr_payroll.holiday_type_work_risk_imss'))
        self._generate_leave(date(2024, 3, 4), date(2024, 3, 6), self.env.ref('l10n_mx_hr_payroll.holiday_type_maternity_imss'))
        self._generate_leave(date(2024, 4, 1), date(2024, 4, 3), self.env.ref('l10n_mx_hr_payroll.holiday_type_disability_due_to_illness_imss'))
    ...
    def test_christmas_bonus_3(self):
        ...
        self._generate_leave(date(2024, 1, 3), date(2024, 1, 3), self.env.ref('l10n_mx_hr_payroll.holiday_type_work_risk_imss'))
        self._generate_leave(date(2024, 1, 4), date(2024, 1, 4), self.env.ref('l10n_mx_hr_payroll.holiday_type_maternity_imss'))
        self._generate_leave(date(2024, 1, 5), date(2024, 1, 5), self.env.ref('l10n_mx_hr_payroll.holiday_type_disability_due_to_illness_imss'))
