...
class HrVersion(models.Model):
    ...
    l10n_ch_lpp_mutations = fields.One2many('l10n.ch.lpp.mutation', 'version_id')
    ...
    l10n_ch_other_employers = fields.Boolean()
    ...
    l10n_ch_contractual_annual_wage = fields.Monetary(string="Contractual Annual Wage", default=0)
    ...
    l10n_ch_contract_wage_ids = fields.One2many("l10n.ch.hr.contract.wage", "version_id", domain=[('date_start', '=', False)], copy=True)
