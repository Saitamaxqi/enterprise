...
class HrSalaryRule(models.Model):
    ...
    def _compute_rule(self, localdict):
        ...
        if self.struct_id.country_id.code != 'MX' or self.code != 'INT_DAY_WAGE_BASE':
            return result
        int_day_wage_base_rule = self.env.ref('l10n_mx_hr_payroll.l10n_mx_category_integrated_daily_wage')
        mx_pay_struct = self.env.ref('l10n_mx_hr_payroll.l10n_mx_regular_pay')
