...
class AccountReturnType(models.Model):
    ...
    def _generate_all_returns(self, country_code, main_company, tax_unit=None):
        ...
        if country_code == 'AE':
            self.env.ref('l10n_ae_reports.ae_tax_return_type')._try_create_returns_for_fiscal_year(main_company, tax_unit=tax_unit)
            self.env.ref('l10n_ae_reports.ae_corporate_tax_return_type')._try_create_returns_for_fiscal_year(main_company, tax_unit=tax_unit)
